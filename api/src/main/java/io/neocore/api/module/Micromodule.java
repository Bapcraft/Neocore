...
public interface Micromodule extends Module {
	...
	/**
	 * Called before being enabled to set up the configuration of the
	 * micromodule.
	 * 
	 * @param config
	 *            The HOCON configuration object
	 */
	...
	/**
	 * Called when all of the other micromodules are being enabled, after
	 * they've all been loaded
	 */
	public void onEnable();

	/**
	 * Called when the micromodule is being disabled, such as when the server is
	 * being shut down
	 */
