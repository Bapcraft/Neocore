...
/**
 * Provides an object representing some kind of property about the player, to be
 * stored in an object of type T.
 * 
 * @author treyzania
 *
 * @param <T>
 *            The type of object storing the player's information.
 */
