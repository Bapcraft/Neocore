...
public interface Group extends Persistent, Comparable<Group> {
	...
	/**
	 * Sets the parent group for this group. Should be null if the group should
	 * not have a parent. The group will inherit all the permissions of this
	 * group.
	 * 
	 * @param parent
	 *            The group to be the new parent.
	 */
	 ...
	 * 
	 * @param context
	 *            The context to set it in, or <code>null</code> if global.
	 * @param node
	 *            The permission node(s) to apply to.
	 * @param state
	...
	/**
	 * @return A map of all of the permissions brought by this group, by context
	 *         name.
	 */
	public List<PermissionEntry> getPermissions();

	/**
	 * Sets the priority of the group. This is used in calculating the effective
	 * permissions after resolving inheritance chains.
	 * 
	 * @param priority
	 *            The priority.
	 */
	...
	/**
	 * Gets the priority of this group. Higher priorities are applied later, so
	 ...
	 * 
	 * @param restriction
	 *            The restriction level of this group.
	 */
	public void setRestrictionLevel(int restriction);

	/**
	 * Returns the restriction level of this Group object. The higher the
	 * restriction level, the higher the restriction level server operators need
	 * to modify the group and manipulate memberships of this group.
	 * 
	...
	public default List<Group> getAncestors() {
		...
		if (parent != null || parent == this) {
			...
			parentGroups.add(0, parent); // Make our parent the immediate
											// ancestor.
			return parentGroups;
	 ...
	 * be able to use flair from the group, potentially defeating the purpose of
	 * this flag.
	 * 
	 * @param secret
	 *            The new state of the secret flag.
	 */
