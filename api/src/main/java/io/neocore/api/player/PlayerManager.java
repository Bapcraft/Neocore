...
public interface PlayerManager {
	...
	/**
	 * Returns a set of the online players. Manipulations to this set will have
	 * no effect on the players online.
	 * 
	...
	/**
	 * Requests a lease for the specified player. If there are no leases for the
	 * player then it will trigger a low-level load for the player data, if
	 ...
	 *            The UUID of the player
	 * @param callback
	 *            Callback to invoke once the player has finished loading
	 * @return
	 */
