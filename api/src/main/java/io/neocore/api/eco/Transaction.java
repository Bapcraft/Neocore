...
/**
 * Represents a transaction of money between two accounts.  There is
 * (currently) no validation that the accounts are of the same type of
 * currency.
 * 
 * @author treyzania
 */
public class Transaction {
	...
	/**
	 * Returns the UUID of the transaction.  This has no correlation to the UUIDs of the two account owners, if any.
	 * 
	...
	/**
	 * @return <code>true</code> if the transaction has been performed, <code>false</code> otherwise.
	 */
