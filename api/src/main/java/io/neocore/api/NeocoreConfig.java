...
public interface NeocoreConfig {
	...
	/**
	 * @return The name of the server not only on the network, but in the
	 *         database as well
	 */
	public String getServerName();

	/**
	 * @return The name of the network the server is on, <code>null</code> if
	 *         standalone
	 */
	...
	/**
	 * @return If this servers is merely an endpoint in a larger network, not
