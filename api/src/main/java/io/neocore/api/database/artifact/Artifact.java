...
public interface Artifact extends Persistent {
	...
	/**
	 * Returns the immutable artifact of the artifact.  This cannot change as
	 * it is used to differentiate how to use the artifact.
	 * 
	 ...
	 * represent things bound onto players or other artifacts.  Can be null if
