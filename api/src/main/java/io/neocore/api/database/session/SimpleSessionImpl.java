 ...
 * @author treyzania
 */
public class SimpleSessionImpl implements PersistentPlayerIdentity, Session {
	...
	public SimpleSessionImpl(UUID uuid, String name, InetAddress src, String inbound) {
