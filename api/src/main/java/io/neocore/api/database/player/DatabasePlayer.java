...
public interface DatabasePlayer extends PlayerIdentity, PersistentPlayerIdentity {
	 ...
	 * 
	 * @param group
	 *            The group membership to be added.
	 */
	 ...
	 * 
	 * @param group
	 *            The group to create a membership for.
	 ...
	 * 
	 * @param group
	 *            The group membership to be removed.
	 */
	...
	/**
	 * Attaches the extension onto the player, replacing any other extensions of
	 * that type.
	 * 
	 * @param ext
	 ...
	 * @return The extension we have on the player, or <code>null</code> if we
	 *         don't have it.
	 */
	 ...
	 * 
	 * @param date
	 *            When the player should have first logged in.
	 */
	public void setFirstLogin(Date date);

	/**
	 * Returns the time that the player first joined the server. Typically just
	 * when this object was first constructed.
	 * 
	...
	/**
	 * @param count
	 *            Sets the number of logins this player has done.
	 */
	...
	/**
	 * Gets a list of all of the flairs that this user has available based on
