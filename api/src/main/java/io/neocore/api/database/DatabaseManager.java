...
/**
 * Manages registration, initialization, and delegation of database
 * controllers.<br/>
...
public interface DatabaseManager {
	 ...
	 * 
	 * @param name
	 *            The name to give the controller.
	 * @param engine
	...
	/**
	 * Gets the database controller with the specified name. Will not
