...
public interface ServiceType {
	...
	/**
	 * Checks to see if the given service provider is compatible with this
	 * service type.
	 * 
	 * @param prov
	 *            The provider.
	...
	public default boolean isCompatible(ServiceProvider prov) {
		return this.getServiceClass() != null && prov != null
				&& this.getServiceClass().isAssignableFrom(prov.getClass());
	}
