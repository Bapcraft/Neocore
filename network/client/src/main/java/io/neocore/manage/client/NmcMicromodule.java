...
public class NmcMicromodule extends JavaMicromodule {
	...
	public void onEnable() {
		...
		this.client = new NmClient(NeocoreAPI.getAgent(), this.handlerManager, ServerType.UNDEFINED,
				NeocoreAPI.isFrontend() ? ServerRole.FRONTEND : ServerRole.ENDPOINT);
		...
		// Set up services.
		this.netMapService = new NmNetworkMapService(NeocoreAPI.getNetworkName()); // FIXME
																					// Network
																					// name.
