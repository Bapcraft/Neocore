...
public class CommandWrapper extends Command {
	...
	public boolean setLabel(String name) {
		...
		if (this.command.isNativeOverride())
			Bukkit.getLogger().warning("Tried to set label of native override command " + this.command.getName()
					+ " to " + name + ", this doesn't do anything really.");
