...
public class NeocoreBukkitPlugin extends JavaPlugin implements FullHostPlugin {
	...
	public void onEnable() {
		...
		this.cmdInjector = new CommandInjector_19r2(); // FIXME Make this figure
														// out the details
														// automatically.
		...
		if (this.config.isNetworked()) {
			NeocoreAPI.getLogger().warning(
					"It is strongly suggested that you run Neocore in standalone mode if you do not have a sync daemon.");
		} else {
