...
public class JdbcGroupService extends AbstractJdbcService implements GroupService {
		...
		try {
			...
			created.setFlushProcedure(() -> {
				...
				try {
					...
					NeocoreAPI.getLogger().log(Level.WARNING, "Problem flushing group to database for the first time.",
							e);
				}
	...
	public List<Group> loadGroups() {
		...
		try {
			...
			// Fill the output list because of how Java doesn't like auto
			// upcasting generics.
