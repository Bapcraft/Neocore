...
public class PlayerConnectionForwarder extends EventForwarder {
	...
	public void onLogin(LoginEvent event) {
		...
		// Bungee doesn't give us a lot of information about players until now,
		// so we do it now.
		BungeeInitialLoginEvent ile = new BungeeInitialLoginEvent(event);
		if (this.loginAcceptor != null)
			this.loginAcceptor.onInitialLoginEvent(ile);
	...
	public void onPostLogin(PostLoginEvent event) {
		...
		if (this.loginAcceptor != null)
			this.loginAcceptor.onPostLoginEvent(new BungeePostLoginEvent(pl.getPlayer()));
	...
	public void onPlayerQuit(PlayerDisconnectEvent event) {
		...
		// Now we call this to make sure the player is fully loaded before we
		// try to unload it.
		try {
	...
	public void onDownstreamConnectEvent(ServerConnectEvent event) {
		...
		if (this.proxyAcceptor != null)
			this.proxyAcceptor.onDownstreamTransfer(neoEvent);
